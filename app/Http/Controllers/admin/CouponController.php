...
class CouponController extends Controller
{
    public function index(Request $request) {
		...
		if ($request->ajax()) {
			...
			return DataTables::of($coupons)
				...
				->addColumn('vendor_name', function ($coupons) {
					return $coupons->vendor->name ?? "";
				})
				->addColumn('action', function($coupons) {
					
					$editUrl   = route('admin.coupon.edit', $coupons->id);
					$deleteUrl = route('admin.coupon.destroy', $coupons->id);
					$token = csrf_token();
    ...
    public function create() {
		...
		return view('admin.coupon.create',compact('vendors'));
    }
    ...
    public function edit($id) {
        ...
        return view('admin.coupon.edit', compact('coupon','vendors'));
    }
