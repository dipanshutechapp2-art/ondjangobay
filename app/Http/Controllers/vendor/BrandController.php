...
class BrandController extends Controller
 {
    public function index(Request $request)
    {
		...
		if ($request->ajax()) {
			...
			return DataTables::of($brands)
				...
				->addColumn('action', function($brands) {					
					$deleteUrl = route('product-brands.destroy', $brands->id);
					$token = csrf_token();
					return '
						<div class="btn-group">
        ...
        return view('vendor.brands.list', compact('brands'));
    }
...
public function store(Request $request)
{
    ...
    return redirect()->route('product-brands.index')->with('success', 'brands created successfully.');
}
    ...
    public function edit($id)
        {
            ...
            return view('vendor.brands.edit', compact('slider','brands'));
        }
   ...
   public function destroy(Brands $brand,$id)
        {   
            ...
            //$brand->delete();
            return redirect()->route('product-brands.index')->with('success', 'brands deleted successfully.');
        }
