...
class LanguageController extends Controller
{
    public function index(Request $request) {
		...
		if ($request->ajax()) {
			...
			return DataTables::of($languages)
				...
				->addColumn('action', function($languages) {
						...
						$editUrl     = route('vendor-languages.edit', $languages->id);
						$deleteUrl   = route('vendor-languages.destroy', $languages->id);
						$token       = csrf_token();
        ...
        return view('vendor.languages.index');
    }

    public function create() {
		
        return view('vendor.languages.create');
    }
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('vendor-languages.index')->with('success', 'Language added successfully.');
    }
    ...
    public function edit($id) {
        ...
        return view('vendor.languages.edit', compact('language'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('vendor-languages.index')->with('success', 'Language updated successfully.');
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('vendor-languages.index')->with('success', 'Language deleted successfully.');
    }
