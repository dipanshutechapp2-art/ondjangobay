...
class ProductController extends Controller
{
    public function index(Request $request) {
		...
		if ($request->ajax()) {
			...
			$products = Product::with('categories','attributes','stores')->where('seller_id',Auth::user()->id)->get();
			...
			return DataTables::of($products) 
				...
				->addColumn('action', function($products) {
					...
					$editUrl   = route('products.edit', $products->id);
					$deleteUrl = route('products.destroy', $products->id);
					$token = csrf_token();
				...
				->rawColumns(['action', 'status','image','is_varient','category','stores','price'])
				->make(true);
		}
		
		return view('vendor.products.list');
    }
    ...
    public function create() {
		...
		$attributes  = Attribute::with('values')->where('vendor_id',Auth::user()->id)->get();
		$brands      = Brands::where('status','1')->get();
		
        return view('vendor.products.create',compact('categories','attributes','stores','brands'));
    }
    ...
    public function edit($id) {
		...
		return view('vendor.products.edit', compact('product','categories','attributes','selectedCategories','selectedStores','stores','brands'));
    }
