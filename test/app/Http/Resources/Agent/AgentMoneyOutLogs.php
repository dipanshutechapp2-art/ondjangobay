        ...
        $statusInfo = [
            ...
            if($this->attribute == payment_gateway_const()::SEND){
                return[
                    ...
                    'recipient_received' => getAmount(@$this->details->charges->receiver_amount,get_wallet_precision()).' '.get_default_currency_code(),
                ...
                return[
                    ...
                    'trx' => @$this->trx_id,
                    'transaction_type' => $this->type,
                    'transaction_heading' => "Money Out From @" . @$this->details->sender_email,
                    ...
                    'payable' => getAmount(@$this->request_amount,2).' '.get_default_currency_code(),
                    'recipient_received' => getAmount(@$this->details->charges->receiver_amount,2).' '.get_default_currency_code(),
