...
class MerchantPaymentLogs extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'sender_amount' => getAmount($this->details->charges->sender_amount,get_wallet_precision()).' '.get_default_currency_code(),
            'recipient' =>  $this->details->receiver_username,
            'recipient_amount' => getAmount($this->details->charges->receiver_amount,get_wallet_precision()).' '.get_default_currency_code(),
