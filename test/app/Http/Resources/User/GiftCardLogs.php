...
class GiftCardLogs extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return[
            ...
            'card_unit_price' => getAmount($this->details->card_info->card_amount,get_wallet_precision()).' '.$this->details->card_info->card_currency,
            'card_quantity' => $this->details->card_info->qty,
            'card_total_price' => getAmount($this->details->card_info->card_total_amount,get_wallet_precision()).' '.$this->details->card_info->card_currency,
            'exchange_rate' => '1 ' .@$this->details->charge_info->card_currency.' = '.getAmount(@$this->details->charge_info->exchange_rate,get_wallet_precision()).' '.@$this->details->charge_info->wallet_currency,
