        ...
        try{
           ...
           if( $basic_setting->email_notification == true){
            ...
            $notifyDataSender = [
                ...
                'request_amount'  => getAmount($charges['request_amount'],get_wallet_precision()).' '.$charges['sender_currency'],
                'payable'   =>  getAmount($charges['payable'],get_wallet_precision()).' ' .$charges['receiver_currency'],
                'charges'   => getAmount( $charges['total_charge'],get_wallet_precision()).' ' .$charges['receiver_currency'],
                'will_get'  => getAmount( $charges['request_amount'],get_wallet_precision()).' ' .$charges['sender_currency'],
                'status'  => __("Pending"),
            ];
            try{
