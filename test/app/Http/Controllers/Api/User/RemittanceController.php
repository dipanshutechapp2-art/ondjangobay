...
class RemittanceController extends Controller
{
    ...
    public function confirmed(Request $request){
        ...
        //daily and monthly
        try{
            (new TransactionLimit())->trxLimit('user_id',$userWallet->user->id,PaymentGatewayConst::SENDREMITTANCE,$userWallet->currency,$send_amount,$exchangeCharge,PaymentGatewayConst::SEND);
        }catch(Exception $e){
        ...
        try{
            if($transaction_type === Str::slug(GlobalConst::TRX_WALLET_TO_WALLET_TRANSFER)){
                ...
                $notifyData = [
                    ...
                    'request_amount'  => getAmount($send_amount,get_wallet_precision()).' '.get_default_currency_code(),
                    ...
                    'receiver_get'   =>  getAmount($receiver_will_get,get_wallet_precision()).' ' .$to_country->code,
                    'status'  => __("Pending"),
                  ];
