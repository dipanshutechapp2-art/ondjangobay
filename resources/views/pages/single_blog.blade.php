	...
	<!-- Start of Main -->
        <main class="main">
            ...
            <div class="page-header">
                <div class="container">
                    <h1 class="page-title mb-0">Single Blog</h1>
                </div>
            </div>
            <!-- End of Page Header -->
                        ...
                        <div class="main-content post-single-content">
                            <div class="post post-grid post-single">
                                <figure class="post-media br-sm">
                                    <img src="{{url('/frontend/assets/images/blog/single/1-1.jpg')}}" alt="Blog" width="930" height="500">
                                </figure>
                            ...
                            <div class="post-author-detail">
                                <figure class="author-media mr-4">
                                    <img src="{{ asset('frontend/assets/images/blog/single/1-1.png')}}" alt="Author" width="105" height="105">
                                </figure>
                                ...
                                <div class="post-slider swiper-container swiper-theme nav-top pb-2" data-swiper-options="{
                                    ...
                                    <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-xs-2 cols-1">
                                        <div class="swiper-slide post post-grid">
                                            <figure class="post-media br-sm">
                                                <a href="post-single-1.html">
                                                    <img src="{{ asset('frontend/assets/images/blog/single/2-1.jpg')}}" alt="Post" width="296" height="190" style="background-color: #bcbcb4;">
                                                </a>
                                            </figure>
                                            <div class="post-details text-center">
                                                ...
                                                <h4 class="post-title mb-3"><a href="post-single-1.html">Fashion tell about who you are from...</a></h4>
                                                <a href="post-single-1.html" class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i class="w-icon-long-arrow-right"></i></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide post post-grid">
                                            <figure class="post-media br-sm">
                                                <a href="post-single-1.html">
                                                    <img src="{{ asset('frontend/assets/images/blog/single/3-1.jpg')}}" alt="Post" width="296" height="190" style="background-color: #cad2d1;">
                                                </a>
                                            </figure>
                                            <div class="post-details text-center">
                                                <div class="post-meta">
                                                ...
                                                <h4 class="post-title mb-3"><a href="post-single-1.html">Comes a cool blog post with Images</a></h4>
                                                <a href="post-single-1.html" class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i class="w-icon-long-arrow-right"></i></a>
                                            </div>
                                        </div>
                                        <div class="swiper-slide post post-grid">
                                            <figure class="post-media br-sm">
                                                <a href="post-single-1.html">
                                                    <img src="{{ asset('frontend/assets/images/blog/single/4-1.jpg')}}" alt="Post" width="296" height="190" style="background-color: #ececec;">
                                                </a>
                                            </figure>
                                            <div class="post-details text-center">
                                                <div class="post-meta">
                                        ...
                                        <div class="swiper-slide post post-grid">
                                            <figure class="post-media br-sm">
                                                <a href="post-single-1.html">
                                                    <img src="{{ asset('frontend/assets/images/blog/single/5-1.jpg')}}" alt="Post" width="296" height="190" style="background-color: #AFAFAF;">
                                                </a>
                                            </figure>
                                            <div class="post-details text-center">
                                                <div class="post-meta">
                                                ...
                                                <h4 class="post-title mb-3"><a href="post-single-1.html">We want to be different and fashion gives to me that outlet</a></h4>
                                                <a href="post-single-1.html" class="btn btn-link btn-dark btn-underline font-weight-normal">Read More<i class="w-icon-long-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <ul class="comments list-style-none pl-0">
                                <li class="comment">
                                    <div class="comment-body">
                                        <figure class="comment-avatar">
                                            <img src="{{ asset('frontend/assets/images/blog/single/1-1.png')}}" alt="Avatar" width="90" height="90">
                                        </figure>
                                ...
                                <li class="comment">
                                    <div class="comment-body">
                                        <figure class="comment-avatar">
                                            <img src="{{ asset('frontend/assets/images/blog/single/2-1.png')}}" alt="Avatar" width="90" height="90">
                                        </figure>
                                        <div class="comment-content">
                                            <h4 class="comment-author font-weight-bold">
                                                <a href="#">Semi Colon</a>
                                ...
                                <div class="sticky-sidebar">
                                                    ...
                                                    <div class="swiper-wrapper row cols-1">
                                                        ...
                                                        <div class="swiper-slide widget-col">
                                                            ...
                                                            <div class="post-widget mb-2">
                                                                ...
                                                                <div class="post-details">
                                                                    <div class="post-meta">
                                                                        <a href="{{url('/single-blog')}}" class="post-date">March 1, 2021</a>
                                                                    </div>
                                                                    <h4 class="post-title">
                                    ...
                                    <div class="widget widget-tags">
                                        ...
                                        <div class="widget-body tags">
                                            <a href="{{url('/blog')}}" class="tag">Fashion</a>
                                            <a href="{{url('/blog')}}" class="tag">Style</a>
                                            <a href="{{url('/blog')}}" class="tag">Travel</a>
                                            <a href="{{url('/blog')}}" class="tag">Women</a>
                                            <a href="{{url('/blog')}}" class="tag">Men</a>
                                            <a href="{{url('/blog')}}" class="tag">Hobbies</a>
                                            <a href="{{url('/blog')}}" class="tag">Shopping</a>
                                            <a href="{{url('/blog')}}" class="tag">Photography</a>
                                        </div>
                                    </div>
