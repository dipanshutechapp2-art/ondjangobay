...
@section('content')
	<main class="main">
            ...
            <div class="page-content become-a-vendor">
                <div class="container create-store pb-1 pb-lg-10 mb-10">
                    <div class="row align-items-center">
                        <div class="col-md-6 mb-4 mb-md-0">
                            <figure class="br-sm">
                                <img src="{{asset('frontend/assets/images/pages/become/1-1.jpg')}}" alt="Banner" width="610" height="435" style="background-color: #D9D8DD;">
                            </figure>
                        </div>
                        <div class="col-md-6 order-md-first">
                            ...
                            <a href="{{url('/')}}" class="btn btn-dark btn-outline btn-rounded ls-25">Learn More</a>
                        </div>
                    </div>
                    <!-- End of Row -->
                </div>
                    ...
                    <div class="container mt-2 mt-lg-10 mb-0 mb-lg-10">
                        <div class="row align-items-center">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <figure class="br-sm">
                                    <img src="{{asset('frontend/assets/images/pages/become/2-1.jpg')}}" alt="Banner" width="610" height="520" style="background-color: #C9C8CD;">
                                </figure>
                            </div>
                    ...
                    <div class="container mt-0 mt-lg-10 mb-2 mb-lg-9">
                        <div class="row">
                            <div class="col-lg-4 mb-4 mb-lg-0">
                                ...
                                <a href="{{url('/')}}" class="btn btn-dark btn-link btn-underline btn-icon-right">
                                        ...
                                        <div class="swiper-wrapper row cols-sm-2">
                                                ...
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="{{asset('frontend/assets/images/agents/1-100x100-1.png')}}" alt="Testimonial" width="100" height="100">
                                                        </figure>
                                            ...
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class="testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="{{asset('frontend/assets/images/agents/2-100x100-1.png')}}" alt="Testimonial" width="100" height="100">
                                                        </figure>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 100%;"></span>
                                            ...
                                            <div class="swiper-slide testimonial-wrap">
                                                <div class="testimonial testimonial-centered testimonial-boxed bg-white br-sm">
                                                    <div class=" testimonial-info">
                                                        <figure class="testimonial-author-thumbnail">
                                                            <img src="{{asset('frontend/assets/images/agents/3-100x100-1.png')}}" alt="Testimonial" width="100" height="100">
                                                        </figure>
                                                        <div class="ratings-container">
                                                            <div class="ratings-full">
                                                                <span class="ratings" style="width: 100%;"></span>
                ...
                <div class="banner parallax" data-parallax-options="{'speed': 10, 'parallaxHeight': '200%', 'offset': -99}" data-image-src="{{asset('frontend/assets/images/pages/become/3.jpg')}}" style="background-color: #929294;">
                    <div class="container">
                        <div class="banner-content text-center">
                            <h2 class="title title-center text-white font-weight-bold">Let’s talk about how we can make
                                    brands work for you</h2>
                            <a href="{{url('/')}}" class="btn btn-white btn-outline btn-rounded ls-25">Register Now</a>
                        </div>
                    </div>
                </div>
            </div>
