                ...
                <div class="container">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="wishlist-action">
                                    <div class="d-lg-flex">
                                        <a href="{{url('/')}}" class="btn  btn-outline btn-default btn-rounded btn-sm mb-2 mb-lg-0">Quick
                                            View</a>
                                        <a href="{{url('/')}}" class="btn btn-dark btn-rounded btn-sm ml-lg-2 btn-cart">Add to
                                            cart</a>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="{{url('/')}}">
                                            <figure>
                                                <img src="{{asset('frontend/assets/images/shop/19-1-1.jpg')}}" alt="product" width="300" height="338">
                                            </figure>
                                        </a>
                                        <button type="submit" class="btn btn-close"><i class="fas fa-times"></i></button>
                                    </div>
                                ...
                                <td class="wishlist-action">
                                    <div class="d-lg-flex">
                                        <a href="{{url('/')}}" class="btn btn-quickview btn-outline btn-default btn-rounded btn-sm mb-2 mb-lg-0">Quick
                                            View</a>
                                        <a href="{{url('/')}}" class="btn btn-dark btn-rounded btn-sm ml-lg-2 btn-cart">Add to
                                            cart</a>
                                    </div>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <div class="p-relative">
                                        <a href="{{url('/')}}">
                                            <figure>
                                                <img src="{{asset('frontend/assets/images/shop/20-1.jpg')}}" alt="product" width="300" height="338">
                                            </figure>
                                        </a>
                                        <button type="submit" class="btn btn-close"><i class="fas fa-times"></i></button>
                                    </div>
                    ...
                    <div class="social-links">
                        ...
                        <div class="social-icons social-no-color border-thin">
                            ...
                            <a href="{{url('/')}}" class="social-icon social-email far fa-envelope"></a>
