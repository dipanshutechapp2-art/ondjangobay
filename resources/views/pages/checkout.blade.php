            ...
            <div class="page-content">
                <div class="container">
                    <div class="login-toggle">
                        Returning customer? <a href="{{url('/')}}" class="show-login font-weight-bold text-uppercase text-dark">Login</a>
                    </div>
                    <form class="login-content">
                        ...
                        <div class="form-group checkbox">
                            ...
                            <a href="{{url('/order-complete')}}" class="ml-3">Last your password?</a>
                        </div>
                        <button class="btn btn-rounded btn-login">Login</button>
                    </form>
                    <div class="coupon-toggle">
                        Have a coupon? <a href="{{url('/order-complete')}}" class="show-coupon font-weight-bold text-uppercase text-dark">Enter your
                            code</a>
                    </div>
