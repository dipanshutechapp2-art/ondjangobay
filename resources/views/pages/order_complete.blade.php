        ...
        <main class="main order">
            ...
            <div class="page-content mb-10 pb-2">
                <div class="container">
                                    ...
                                    <address class="mb-4">
                                        <table class="address-table">
                                            <tbody>
                                                ...
                                                <tr class="email">
                                                    <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f7999e94928098859cc6c5c2b7909a969e9bd994989a">[email&#160;protected]</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </address>
                    ...
                    <a href="{{url('/')}}" class="btn btn-dark btn-rounded btn-icon-left btn-back mt-6"><i class="w-icon-long-arrow-left"></i>Back To List</a>
                </div>
            </div>
            <!-- End of PageContent -->
        </main>
