													...
													@foreach($product->galleryImages as $galleryImg)
														<div class="swiper-slide">
															@if(!empty($product->auto_ds_product_id))
																<figure class="product-image">
																	<img src="{{$galleryImg->image}}" data-zoom-image="{{$galleryImg->image}}" alt="{{$product->name}}" width="800" height="900"/>
																</figure>
															@else
																<figure class="product-image">
                                            ...
                                            <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                                @if(!empty($product->galleryImages))
													...
													@foreach($product->galleryImages as $galleryImg)
														<div class="product-thumb swiper-slide">
															@if(!empty($product->auto_ds_product_id))
																 <img src="{{$galleryImg->image}}" alt="Product Thumb" width="800" height="900">
															@else
