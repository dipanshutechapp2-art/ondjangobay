...
@section('content')
    ...
    <div class="content-wrapper admin-dashboard-content">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{ route('users.update',$agent->id) }}" method="POST" enctype="multipart/form-data">
         @csrf   
         @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-password" name="password" placeholder="Leave Blank If you want old Password..." value="" >
            </div>
