                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-4">
										  <div class="card-header">
											...
											@endif
										  <div class="card-body">
											<form class="geniusform" action="{{ url('/admin/currency/edit_currency_action') }}" method="POST" enctype="multipart/form-data">
											 @csrf 
                                                @method('POST')		
												...
												<div class="form-group">
													...
													<input type="number" class="form-control" id="inp-name" name="display_order" placeholder="0" value="{{ $currencyInfo->display_order }}" required>
													@error('display_order')
														<span class="invalid-feedback" role="alert">
															<strong>{{ $message }}</strong>
														</span>
