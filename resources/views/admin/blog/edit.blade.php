                    ...
                    <div class="col-md-10">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control" id="inp-slug" name="slug" placeholder="Enter Slug" value="" required="">
                 </div> -->
                                    <div class="form-group">
                                        ...
                                        <div class="wrapper-image-preview">
                                            <div class="box">
                                                <div class="back-preview-image"
                                                    style="background-image: url({{ asset('uploads/blog') }}/{{ $blog->photo }});">
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" id="summernote" name="description" rows="3" placeholder="Description"
                                            style="display: none;" rows="3">{{ $blog->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="source" name="source"
                                            placeholder="Source" value="{{ old('source', $blog->source) }}">
                                        @error('source')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="meta_tags" class="form-control" placeholder="Enter Meta Tags"
                                            id="meta_tags" value="{{ old('meta_tags', $blog->meta_tags) }}">
                                        @error('meta_tags')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" id="summernote2" name="meta_description" rows="3"
                                            placeholder="Meta Description" style="display: none;" rows="3"> {{ $blog->meta_description }}</textarea>
