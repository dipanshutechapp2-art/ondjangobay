                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        {{-- ✅ Upload Form --}}
                                        <div class="card-body">
                                            <form action="{{ route('adminimages.upload') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                        ...
                                        @if (count($uploadedPaths) > 0)
                                            <div class="card mb-4 shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <a href="{{ route('adminimages.upload.form') }}" class="btn btn-secondary mt-3">⬅ Upload More</a>
                                                </div>
                                            </div>
                                        @endif
                                    @endisset
