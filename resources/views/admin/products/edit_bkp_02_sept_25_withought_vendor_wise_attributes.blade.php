											...
											<form class="geniusform" onsubmit="return validateBeforeSubmit()" action="{{ route('admin.products.update',$product->id) }}" method="POST" enctype="multipart/form-data">
											 @csrf 
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="inp-email" name="short_description" placeholder="Short description">{{ $product->short_description }}</textarea>
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="inp-email" name="description" placeholder="Description">{{ $product->description }}</textarea>
													@error('description')
														<span class="invalid-feedback" role="alert">
															<strong>{{ $message }}</strong>
														</span>
