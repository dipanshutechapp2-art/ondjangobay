...
@section('content')
    ...
    <div class="content-wrapper admin-dashboard-content">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{ route('vendor.store') }}" method="POST" enctype="multipart/form-data">
         @csrf   
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="inp-password" name="password" placeholder="Enter password" value="{{ old('password') }}" >
            </div>
