...
@section('content')
    ...
    <div class="content-wrapper admin-dashboard-content">
        ...
        <a href="{{ route('vendor.index') }}" class="btn btn-danger btn float-right">
      ...
      <div class="card-body">
        ...
        <form class="geniusform" action="{{ route('vendor.update',$agent->id) }}" method="POST" enctype="multipart/form-data">
         @csrf   
         @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inp-name" name="name" placeholder="Enter Name" value="{{ $agent->name }}" >
            </div>

            <div class="form-group">
                <label for="inp-email">Email</label>
                <input type="email" class="form-control" id="inp-email" name="email" placeholder="Enter Email" value="{{ $agent->email }}"  >
            </div>

            <div class="form-group">
                <label for="inp-phone">Phone</label>
                <input type="tel" class="form-control" id="inp-phone" name="phone" placeholder="Enter Phone" value="{{ $agent->phone }}" >
            </div>
            <!--<div class="form-group">
                <label for="inp-phone">Password</label>
                <input type="password" class="form-control" id="inp-password" name="password" placeholder="Leave Blank If you want old Password..." value="" >
            </div>-->
...
<script>
    ...
    <script>
        ...
        `,
                ...
                $.ajax({
                    url: '{{ url('admin/users') }}/' + locationId,
                    type: 'POST',
                    data: fd,
                    processData: false,
                    contentType: false,
