        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
          <tr>
		   ...
		   <tr>
            ...
            <td style="padding:10px 0; text-align:right; color:#333;">{{ ucfirst($order->status) }}</td>
          </tr>
		  ...
		  <tr style="border-top:1px solid #eee;">
            ...
            <td style="padding:10px 0; text-align:right; color:#333;">{{ $order->currency }}{{ number_format($order->amount, 2) }}</td>
          </tr>
          <tr style="border-top:1px solid #eee;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px;">
          <tr style="background:#f9f9f9;">
            ...
            <th align="right" style="padding:12px; border:1px solid #eee;">Price</th>
			  ...
			  <tr>
				<td style="padding:12px; border:1px solid #eee;">{{ $order->product->name ?? 'N/A' }}</td>
				<td align="center" style="padding:12px; border:1px solid #eee;">{{ $order->quantity }}</td>
				<td align="right" style="padding:12px; border:1px solid #eee;">{{ $order->currency }}{{ number_format($order->amount, 2) }}</td>
			  </tr>

			  <tr>
				<td colspan="2" align="right" style="padding:12px; border:1px solid #eee;"><strong>Total:</strong></td>
				<td align="right" style="padding:12px; border:1px solid #eee;">{{ $order->currency }}{{ number_format($order->amount, 2) }}</td>
			  </tr>
        </table>
      </td>
