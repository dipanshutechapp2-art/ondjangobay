                        ...
                        <div class="tab-content mb-6">
                            <div class="tab-pane" id="account-dashboard">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6 mb-4">
                                        <a href="wishlist-1.html" class="link-to-tab">
                                            <div class="icon-box text-center">
                            ...
                            <div class="tab-pane mb-4" id="account-orders">
                                ...
                                <a href="shop-banner-sidebar-1.html" class="btn btn-dark btn-rounded btn-icon-right">Go
                            ...
                            <div class="tab-pane active order">
                                    ...
                                    <table class="order-subtable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="action"><a href="{{url('/order-view')}}" class="btn btn-rounded">View</a></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <address class="mb-4">
                                                    <table class="address-table">
                                                        <tbody>
                                                            ...
                                                            <tr class="email">
                                                                <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6c02050f091b031e075d5e592c0b010d0500420f0301">[email&#160;protected]</a></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </address>
                                ...
                                <a href="{{url('/')}}" class="btn btn-dark btn-rounded btn-icon-left btn-back mt-6 mb-6"><i class="w-icon-long-arrow-left"></i>Back To List</a>
                            </div>
                        </div>
                    </div>
                </div>
