...
<!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('frontend/assets/footer-logo.png')}}">
	  ...
	  <nav class="main-header navbar navbar-expand navbar-white navbar-light admin-dashboard-top ">
		...
		<ul class="navbar-nav">
		  ...
		  <!-- <li class="nav-item d-none d-sm-inline-block">
			...
			<a href="{{ url('/vendor/dashboard') }}" class="nav-link">Contact</a>
		...
		<ul class="navbar-nav ml-auto">
		  ...
		  <li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
			  ...
			  <span class="dropdown-item dropdown-header">@if(auth()->check()) {{ Auth::user()->name }} @else Testing @endif</span>
			  ...
			  <a href="{{ url('vendor/logout') }}" class="dropdown-item"   onclick="event.preventDefault();document.getElementById('logout-form').submit();">

				<i class="right fas fa-angle-left"></i>&nbsp;&nbsp;Logout
