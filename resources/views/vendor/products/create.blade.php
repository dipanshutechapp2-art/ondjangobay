                                    ...
                                    <div class="col-md-12">
                                        <div class="card mb-4">
										  <div class="card-header">
											...
											@endif
										  <div class="card-body">
											<form class="geniusform"  onsubmit="return validateBeforeSubmit()"  action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
											 @csrf   
												...
												<div class="form-group" >
													...
													<input id="select_files" type="file" class="form-control @error('image') is-invalid @enderror" name="image" placeholder="Select file.." required>
													@error('image')
														<span class="invalid-feedback" role="alert">
															<strong>{{ $message }}</strong>
														</span>
